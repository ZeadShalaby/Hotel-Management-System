...
<body>
    ...
    <div class="topnav" id="navbar">
     ...
     <p id="fox">Fox Hotel</p>
      ...
      <a href="http://localhost/Project%20Hotel/suite.php">ٍ<i class="fa fa-bed"style="margin:5px"></i>SUITE</a>  
      <a href="http://localhost/Project%20Hotel/DoubleRooms.php"class="active"><i class="fa fa-bed"style="maroon;margin:5px"></i>Double Rooms</a>
      <a href="http://localhost/Project%20Hotel/ShowRoom.php"><i class="fa fa-bed"style="margin:5px"></i>Singl Rooms</a>
      <a href="http://localhost/Project%20Hotel/Home.php"><i class="fa fa-fw fa-home" ></i> Home</a>
    </div>
    </nav>

    <div class="container">
      <img src="image/hotel/sex.png" alt="Avatar" class="image00">
       <a href="#" class="overlay1" style="text-decoration: none; color: skyblue ;" >Fantasy Books</a>
        </div>
        <div class="container1">
     <img src="image/f1.jpg" alt="Avatar" class="image1">
     <a href="#" class="overlay1" style="text-decoration: none; color: lightgray ;" >Mystery Books</a>
        </div>
         <div class="container2">
      <img src="image/f1.jpg"alt="Avatar" class="image2">
      <a href="#" class="overlay1" style="text-decoration: none; color: skyblue;" >Adventure Books</a>
        </div>
        <div class="container3">
          <img src="image/hotel/dou.png"alt="Avatar" class="image3">
          <a href="http://localhost/Library_Management_System/space%20book.php" class="overlay1" style="text-decoration: none; color: skyblue ;" >Space Books</a>
            </div>
                <div class="container4">
          <img src="image/hotel/dou1.png"alt="Avatar" class="image4">
          <a href="http://localhost/Library_Management_System/romantic%20bock.php" class="overlay1" style="text-decoration: none; color: skyblue ;" >Romantic Books</a>
            </div>
                <div class="container5">
          <img src="image/hotel/dou3.png"alt="Avatar" class="image5">
          <a href="http://localhost/Library_Management_System/philosophy%20bock.php" class="overlay1" style="text-decoration: none; color: skyblue ;" >Philosophy Books</a>
      </div>
      <div class="container6">
        <img src="image/f1.jpg" alt="Avatar" class="image1" style="border-color:magenta ;">
        <a href="#" class="overlay1" style="text-decoration: none; color: lightgray ;" >Mystery Books</a>
           </div>
            <div class="container7">
         <img src="image/f1.jpg"alt="Avatar" class="image2" style="border-color: lavenderblush;">
         <a href="#" class="overlay1" style="text-decoration: none; color: skyblue;" >Adventure Books</a>
           </div>
           <div class="container8">
            <img src="image/footer.jpg" alt="Avatar" class="image00">
             <a href="#" class="overlay1" style="text-decoration: none; color: skyblue ;" >Fantasy Books</a>
              </div>
</body>
...
<script src="js/DRooms.js"></script>
