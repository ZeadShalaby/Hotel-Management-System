...
<head>
    ...
    <link href="checkout00.css" rel="stylesheet">
...
<body>
    ...
    <div class="topnav" id="navbar">
     ...
     <p id="fox">Fox Hotel</p>
      ...
      <a href="http://localhost/Project%20Hotel/Checkout.php"  class="active"><i class='fa fa-money' style="color:green;margin:5px"></i>Checkout</a>  
