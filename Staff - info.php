...
<head>
    ...
    <link href="Staff - info000.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href=" https://icons8.com/icon/ejub91zEY6Sl/chrome">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Imperial+Script&display=swap" rel="stylesheet">
    <title>Staff_info_Hotel_Fox</title>
</head>
<body>
   <?php
if($email)
{
$sql = "SELECT name FROM `staff` WHERE email='".$_SESSION['email']."';";
...
?>
    ...
    <div class="topnav" id="navbar">
     ...
     <img src="image/s.png"style="border-radius: 150px ;width: 70px;margin-left: 28rem;margin-top: -100px;">
...
<div ><img src="image/s.png" alt="staf" id="img"style="margin-left: 43rem;"></div>
...
<?php
   ...
   if($email){
         ...
         $count=0;
         $res=mysqli_query($db,"SELECT * FROM `staff`WHERE email='".$_SESSION['email']."';");
          ...
          echo '<table  id="customer" >';
            ...
            echo "<td>";echo "<b> password: </b>";echo "</td>";
              ...
              echo "<td>"; echo $row['pass']; echo "</td>";
                   echo "</tr>";
             echo "<tr>";
             echo "<td>";echo "<b> Admin: </b>";echo "</td>";
           
              echo "<td>"; echo "Zead Shalaby"; echo "</td>";
                   echo "</tr>";
                   echo "<tr>";
            echo "<td>";echo "<b>Contact_A: </b>";echo "</td>";
