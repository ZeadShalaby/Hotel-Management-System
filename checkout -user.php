...
<head>
    ...
    <link href="checkout -user000.css" rel="stylesheet">
...
?>
  ...
  <div id="myNav" class="overlay3">
   ...
   <a href="javascript:void(0)" class="closebtn" id="close" onclick="closeNav()">&times;</a>
     <div class="overlay3-content">
      ...
      <a href="vProject%20Hotel/customer%20-info.php"> <i class="fa fa-drivers-license-o" style="font-size: 35px; margin-left: 2.5rem;"></i></a>
 ...
 <script src="js/checkout -user.js">
...
$count=0;                                          
if($numroom>=1){
$sql = "SELECT * FROM `info` WHERE numroom='".$_SESSION['numroom']."';";
$res=mysqli_query($db,$sql);
while ($row=mysqli_fetch_assoc($res)) {   
if(($_SESSION['numroom']>=1)){
...
$numroom0="";
         ...
         <form action=" " method="post">
            ...
            <ul class="form-list">
              <li class="form-list-row">
                ...
                <input name ="fname" type="text"placeholder="sscsc" required value="<?php if(!isset($_POST['Checkout'])) {echo $name ;}
                 else{echo "";}?>"> 

                <input name="lname" class="user1"type="text"placeholder="sscsc"  required value="<?php if(!isset($_POST['Checkout'])){echo $lname;}else {echo "" ;}?>">
                </div>
              ...
              <li class="form-list-row">
                <div class="number">
                 ...
                 <input  name ="card number" type="text" placeholder=" 123" required value="<?php if(!isset($_POST['Checkout'])){echo $card_number;}
                 else {echo "" ;}?>">
                
                  <input name="room" class="number1"type="text"placeholder="1" required value="<?php if(!isset($_POST['Checkout'])){echo $room;}
                  else {echo "";} ?>">
              ...
              <li class="form-list-row clearfix">
                <div class="date">
                    <label for="#">NumRoom</label><br> <label id="l2" style="margin-left:18rem">AGE</label><br>
                  

                  <input name="numroom" type="text" required placeholder="123" value="<?php if(!isset($_POST['Checkout'])){echo $numroom0;}
                  else{echo "";} ?>">
                  
                  <input name="age" class="year" type="text" required placeholder="+20" value="<?php if(!isset($_POST['Checkout'])){echo $age ;}
                  else{echo "";}?>">
                </div>
                ...
                <div class="cvc">
                  ...
                  <br>
                  <input name="date" class="month" type="date" required placeholder="0000-00-00" value="<?php if(!isset($_POST['Checkout']))
                  {echo $date ;}else{echo "";}?>"style="margin-left:2rem;color: red;">
                </div>
              </li>
     ...
     <input id="button" type="submit" name="Checkout" value="Checkout" style="margin-left: 14rem;">
...
<br> <br>
   <div id="icon" style="color: rgb(0, 0, 0);">
    ...
    <a href="https://talk.brave.com/widget" target="_blank">
      <img src="icon/icons8-brave-web-browser-48.png" style="height:9%" alt="brave" id="icons0">
    ...
    <a href="https://https://www.meta.com/help/quest/articles/headsets-and-accessories/oculus-link/meta-quest-link-compatibility/" target="_blank">
      <img src="icon/meta.png" alt="brave" style="height:9%"id="icons0">
  
  </a>
   
    <img src="image/f0.jpg" alt="logo down" style="height: 40%;" id="logodownL">
    <img src="image/ff0.jpg" alt="logo down"style="height: 40%;" id="logodownR">
  ...
  <?php
      ...
      if(isset($_POST['Checkout']))
      {
        ...
        if(!$count==0)
        {
          ...
          mysqli_query($db,"DELETE  FROM `info` WHERE numroom='$_POST[numroom]';");
        ...
        else
        {
          ...
          ?>
            <script type="text/javascript">
              alert("Not Found Any Information");
            </script>
          <?php
