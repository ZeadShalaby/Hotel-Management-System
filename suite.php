...
<body>
    ...
    <div class="topnav" id="navbar">
     ...
     <p id="fox">Fox Hotel</p>
      ...
      <a href="http://localhost/Project%20Hotel/suite.php"class="active">ٍ<i class="fa fa-bed"style="margin:5px"></i>SUITE</a>  
      <a href="http://localhost/Project%20Hotel/DoubleRooms.php"><i class="fa fa-bed"style="margin:5px"></i>Double Rooms</a>
    ...
    <div class="container">
      <img src="image/f1.jpg" alt="Avatar" class="image00">
     ...
     <a href="#" class="overlay1" style="text-decoration: none; color: lightgray ;" >Mystery Books</a>
      ...
      <a href="#" class="overlay1" style="text-decoration: none; color: skyblue;" >Adventure Books</a>
        ...
        <div class="container3">
          <img src="image/f1.jpg"alt="Avatar" class="image3">
          ...
          <img src="image/f1.jpg"alt="Avatar" class="image4">
          ...
          <img src="image/f1.jpg"alt="Avatar" class="image5">
